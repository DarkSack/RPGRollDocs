...
export const searchIndex: SearchEntry[] = [
  ...
  h("crafting", "Estructura multibloque", "estructura-multibloque"),
  h("crafting", "Niveles de estación (Forja I-V)", "niveles-de-estacion"),
  h("crafting", "Proficiencia de crafteo", "proficiencia"),
  h("crafting", "Recetas personalizadas", "recetas-personalizadas"),
  h("crafting", "Puente con estaciones vanilla", "recetas-vanilla"),
  h("crafting", "Motores dedicados", "motores-dedicados"),
  h("crafting", "Piedra de amolar", "piedra-de-amolar"),
  h("crafting", "Mesa de cartografía", "mesa-de-cartografia"),
  h("crafting", "Telar", "telar"),
  h("crafting", "Comercio de aldeanos", "comercio-de-aldeanos"),
  h("crafting", "Automatización de Crafter", "automatizacion-de-crafter"),
  h("crafting", "Descubrimiento de recetas", "descubrimiento"),
  h("crafting", "Procesamiento con el dueño offline", "procesamiento-offline"),
